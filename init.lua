...
vim.keymap.set('n', '<leader>ff', find_files_hidden, { desc = '[S]earch [F]iles' })
vim.keymap.set('n', '<leader>fh', require('telescope.builtin').help_tags, { desc = '[S]earch [H]elp' })
vim.keymap.set('n', '<leader>fc', require('telescope.builtin').grep_string, { desc = '[S]earch current [W]ord' })
vim.keymap.set('n', '<leader>fw', live_grep_hidden, { desc = '[S]earch by [G]rep' })
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'css', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim',
    'php', 'html', 'twig', 'json' },
